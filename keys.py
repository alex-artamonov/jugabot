...
tiempos = ((INDICATIVO,'presente', 'presente'), 
...
pronouns = ('yo', 'tú', 'él, ella, usted', 'nosotros, nosotras', 'vosotros, vosotras',
            'ellos, ellas, ustedes', 'vos')

pronouns_short = ('yo', 'tú', 'él, ella, Vd', 'nosotros/as', 'vosotros/as',
            'ellos/as, Vds', 'vos')

pronouns_imperativo = ('(tú)','(usted)', '(nosotros, nosotras)', \
                       '(vosotros, vosotras)','(ustedes)','(vos)')

pronouns_imperativo_short = ('(tú)','(usted)', '(nosotros/as)',\
                       '(vosotros/as)','(ustedes)','(vos)')
